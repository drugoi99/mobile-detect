...
# Origin: https://github.com/serbanghita/mobile-detect
...
class MobileDetect:
    ...
    def __init__(self):
        ...
        self.phoneDevices = {
            'iPhone': 'iPhone|iPod',
            'BlackBerry':  'BlackBerry|BB10|rim[0-9]+|(BBA100|BBB100|BBD100|BBE100|BBF100|STH100)-[0-9]+',
            'Pixel':  '; Pixel',
            'HTC':  [
                ...
                'ADR6400L|ADR6425|001HT|Inspire 4G|Android.*EVO|T-Mobile G1|Z520m|Android [0-9.]+; Pixel'
            ],
            'Nexus':  'Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*Mobile|Nexus 4|Nexus 5|Nexus 5X|Nexus 6',
            'Dell':  'Dell[;]? (Streak|Aero|Venue|Venue Pro|Flash|Smoke|Mini 3iX)|XCD28|XCD35|001DL|101DL|GS01',
            'Motorola':  [
                'Motorola|DROIDX|DROID BIONIC|Droid.*Build|Android.*Xoom|HRI39|MOT-|A1260|A1680|A555|A853|A855|A953|A955',
                ...
                'XT806|XT860|XT862|XT875|XT882|XT883|XT894|XT901|XT907|XT909|XT910|XT912|XT928|XT926|XT915|XT919|XT925|XT1021|Moto E|XT1068|XT1092|XT1052',
            ],
            'Samsung':  [
                'Samsung|SM-G950F|SM-G955F|SM-G9250|GT-19300|SGH-I337|BGT-S5230|GT-B2100|GT-B2700|GT-B2710|GT-B3210|GT-B3310',
            ...
            'LG':  [
                'LG;|LG[- ]?(C800|C900|E400|E610|E900|E-900|F160|F180K|F180L|F180S|730|855|L160|LS740|LS840|LS970|LU6200)',
            ...
            'Xiaomi':  [
                '^(?!.*x11).*xiaomi.*$|POCOPHONE F1|MI 8|Mi 10|Redmi Note 9S|Redmi 5A|Redmi Note 5A Prime|Redmi Note 7 Pro',
        ...
        self.tabletDevices = {
            ...
            'Kindle': 'Kindle|Silk.*Accelerated|Android.*(KFOT|KFTT|KFJWI|KFJWA|KFOTE|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|WFJWAE|KFSAWA|KFSAWI|KFASWI|KFARWI|KFFOWI|KFGIWI|KFMEWI)|Android.*Silk/[0-9.]+ like Chrome/[0-9.]+ (?!Mobile)',
            'SurfaceTablet': 'Windows NT [0-9.]+; ARM;.*(Tablet|ARMBJS)',
            'HPTablet': 'HP Slate (7|8|10)|HP ElitePad 900|hp-tablet|EliteBook.*Touch|HP 8|Slate 21|HP SlateBook 10',
            'AsusTablet': [
                'ME181C|P01Y|PO1MA|P01Z|P027|P024|P00C',
                'K00C|K00E|K00L|TX201LA|ME176C|ME102A|M80TA|ME372CL|ME560CG|ME372CG|ME302KL| K01A | K010 | K011 | K017 | K01E |ME572C|ME103K|ME170C|ME171C|ME70C|ME581C|ME581CL|ME8510C',
                '^.*PadFone((?!Mobile).)*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|K00F',
            ],
            ...
            'AcerTablet': [
                'Android.*; (A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810|A1-811|A1-830)',
                'W3-810|A3-A10|A3-A11|A3-A20|A3-A30|A3-A40'
            ],
            'ToshibaTablet': 'Android.*(AT100|AT105|AT200|AT205|AT270|AT275|AT300|AT305|AT1S5|AT500|AT570|AT700|AT830)|TOSHIBA.*FOLIO',
            'LGTablet': 'L-06C|LG-V909|LG-V900|LG-V700|LG-V510|LG-V500|LG-V410|LG-V400|LG-VK810',
            'FujitsuTablet': 'Android.*(F-01D|F-02F|F-05E|F-10D|M532|Q572)',
            'PrestigioTablet': [
            ...
            'YarvikTablet': [
                'Android.*(TAB10-400|TAB10-410|TAB13-201|TAB274EUK|TAB275EUK|TAB374EUK|TAB462EUK|TAB474EUK|TAB9-200)',
                'Android.*(TAB07-200|TAB07-201-3G|TAB07-210|TAB07-211|TAB07-212|TAB07-214|TAB07-220|TAB07-400|TAB07-485|TAB08-150|TAB08-200|TAB08-201-3G|TAB08-201-30|TAB09-100|TAB09-211|TAB09-410|TAB10-150|TAB10-201|TAB10-211)',
                'Android.*(TAB210|TAB211|TAB224|TAB250|TAB260|TAB264|TAB310|TAB360|TAB364|TAB410|TAB411|TAB420|TAB424|TAB450|TAB460|TAB461|TAB464|TAB465|TAB467|TAB468|TAB07-100|TAB07-101|TAB07-150|TAB07-151|TAB07-152)',
            ],
            ...
            'ArchosTablet': '(101G9|80G9|A101IT)|Qilive 97R|Archos5|ARCHOS (70|79|80|90|97|101|FAMILYPAD|)(b|c|)(G10| Cobalt| TITANIUM(HD|)| Xenon| Neon|XSK| 2| XS 2| PLATINUM| CARBON|GAMEPAD)',
            ...
            'PhilipsTablet': '(PI2010|PI3000|PI3100|PI3105|PI3110|PI3205|PI3210|PI3900|PI4010|PI7000|PI7100)',
            ...
            'MSITablet': 'MSI (Primo 73K|Primo 73L|Primo 81L|Primo 77|Primo 93|Primo 75|Primo 76|Primo 73|Primo 81|Primo 91|Primo 90|Enjoy 71|Enjoy 7|Enjoy 10)',
            ...
            'AdvanTablet': 'Android.* (E3A|T3X|T5C|T5B|T3E|T3C|T3B|T1J|T1F|T2A|T1H|T1i|E1C|T1-E|T5-A|T4|E1-B|T2Ci|T1-B|T1-D|O1-A|E1-A|T1-A|T3A|T4i) ',
            'DanyTechTablet': 'Genius Tab G3|Genius Tab S2|Genius Tab Q3|Genius Tab G4|Genius Tab Q4|Genius Tab G-II|Genius TAB GII|Genius TAB GIII|Genius Tab S1',
            'GalapadTablet': 'Android [0-9.]+; [a-z-]+; G1',
            ...
            'PROSCANTablet': [
                '(PLT8088|PLT8223G|PLT8234G|PLT8235G|PLT8816K|PLT9011|PLT9045K|PLT9233G|PLT9735|PLT9760G|PLT9770G)',
                '(PLT7045KB|PLT7071KG|PLT7072|PLT7223G|PLT7225G|PLT7777G|PLT7810K|PLT7849G|PLT7851G|PLT7852G|PLT8015|PLT8031|PLT8034|PLT8036|PLT8080K|PLT8082)',
                '(PEM63|PLT1023G|PLT1041|PLT1044|PLT1044G|PLT1091|PLT4311|PLT4311PL|PLT4315|PLT7030|PLT7033|PLT7033D|PLT7035|PLT7035D|PLT7044K|PLT7045K)',
            ],
            ...
            'VoninoTablet': [
                '(Argus[ _]?S|Diamond[ _]?79HD|Emerald[ _]?78E|Luna[ _]?70C|Onyx[ _]?S|Onyx[ _]?Z|Orin[ _]?HD|Orin[ _]?S|Otis[ _]?S|SpeedStar[ _]?S|Magnet[ _]?M9|Primus[ _]?94[ _]?3G|Primus[ _]?94HD|Primus[ _]?QS)',
                '(Android.*Q8|Sirius[ _]?EVO[ _]?QS|Sirius[ _]?QS|Spirit[ _]?S)',
            ],
            ...
            'AudioSonicTablet': 'C-22Q|T7-QC|T-17B|T-17P',
            'AMPETablet': 'Android.* A78 ',
            'SkkTablet': 'Android.* (SKYPAD|PHOENIX|CYCLOPS)',
            'TecnoTablet': 'TECNO P9|TECNO DP8D',
            'JXDTablet': [
                'Android.* (F3000|A3300|JXD5000|JXD3000|JXD2000|JXD300B|JXD300|S5800|S7800|S602b|S5110b|S7300|S5300|S602|S603)',
                'Android.* (S5100|S5110|S601|S7100a|P3000F|P3000s|P101|P200s|P1000m|P200m|P9100|P1000s|S6600b|S908|P1000|P300|S18|S6600|S9100)',
            ],
            'iJoyTablet': [
            ...
            'OdysTablet': 'LOOX|XENO10|ODYS[ -](Space|EVO|Xpress|NOON)|XELIO|Xelio10Pro|XELIO7PHONETAB|XELIO10EXTREME|XELIOPT2|NEO_QUAD10',
            'CaptivaTablet': 'CAPTIVA PAD',
            'IconbitTablet': 'NetTAB|NT-3702|NT-3702S|NT-3702S|NT-3603P|NT-3603P|NT-0704S|NT-0704S|NT-3805C|NT-3805C|NT-0806C|NT-0806C|NT-0909T|NT-0909T|NT-0907S|NT-0907S|NT-0902S|NT-0902S',
            'TeclastTablet': [
                'T98 4G|P80|X90HD|X98 Air|X98 Air 3G|X89|P80 3G|X80h|P98 Air|X89HD|P98 3G|P90HD|P89 3G|X98 3G',
                'P70h|P79HD 3G|G18d 3G|P79HD|P89s|A88|P10HD|P19HD|G18 3G|P78HD|A78|P75|G17s 3G|G17h 3G',
                'P85t|P90|P11|P98t|P98HD|G18d|P85s|P11HD|P88s|A80HD|A80se|A10h|P89',
                'P78s|G18|P85|A70h|A70|G17|P18|A80s|A11s|P88HD|A80h|P76s|P76h|P98',
                'A10HD|P78|P88|A11|A10t|P76a|P76t|P76e|P85HD|P85a|P86|P75HD|P76v|A12',
                'P75a|A15|P76Ti|P81HD|A10|T760VE|T720HD|P76|P73|P71|P72|T720SE|C520Ti|T760|T720VE|T720-3GE|T720-WiFi',
            ],
            'OndaTablet': [
                '(V975i|Vi30|VX530|V701|Vi60|V701s|Vi50|V801s|V719|Vx610w|VX610W|V819i|Vi10|VX580W|Vi10|V711s|V813|V811)[\s]+',
                '(V820w|V820|Vi20|V711|VI30W|V712|V891w|V972|V819w|V820w|Vi60|V820w|V711|V813s|V801|V819|V975s|V801|V819)[\s]+',
                '(V819|V818|V811|V712|V975m|V101w|V961w|V812|V818|V971|V971s|V919|V989|V116w|V102w|V973|Vi40)[\s]+|V10 4G',
            ],
            'JaytechTablet': 'TPC-PA762',
            'BlaupunktTablet': 'Endeavour 800NG|Endeavour 1010',
            'DigmaTablet': '(iDx10|iDx9|iDx8|iDx7|iDxD7|iDxD8|iDsQ8|iDsQ7|iDsQ8|iDsD10|iDnD7|3TS804H|iDsQ11|iDj7|iDs10)',
            'EvolioTablet': 'ARIA_Mini_wifi|Aria[ _]Mini|Evolio X10|Evolio X7|Evolio X8|Evotab|Neura',
            'LavaTablet': 'QPAD E704|IvoryS|E-TAB IVORY|E-TAB',
            'AocTablet': 'MW0811|MW0812|MW0922|MTK8382|MW1031|MW0831|MW0821|MW0931|MW0712',
            'MpmanTablet': [
                'MP11 OCTA|MP10 OCTA|MPQC1114|MPQC1004|MPQC994|MPQC974|MPQC973|MPQC804|MPQC784|MPQC780|MPG7|MPDCG75|MPDCG71',
            ...
            'CelkonTablet': 'CT695|CT888|CT[\s]?910|CT7 Tab|CT9 Tab|CT3 Tab|CT2 Tab|CT1 Tab|C820|C720|CT-1',
            'WolderTablet': [
                'miTab (DIAMOND|SPACE|BROOKLYN|NEO|FLY|MANHATTAN|FUNK|EVOLUTION|SKY|GOCAR|IRON|GENIUS|POP|MINT)',
                'miTab (EPSILON|BROADWAY|JUMP|HOP|LEGEND|NEW AGE|LINE|ADVANCE|FEEL|FOLLOW|LIKE|LINK|LIVE|THINK|FREEDOM|CHICAGO|CLEVELAND)',
                'miTab (BALTIMORE-GH|IOWA|BOSTON|SEATTLE|PHOENIX|DALLAS|IN 101|MasterChef)',
            ],
            'MediacomTablet': 'M-MPI10C3G|M-SP10EG|M-SP10EGP|M-SP10HXAH|M-SP7HXAH|M-SP10HXBH|M-SP8HXAH|M-SP8MXA',
            'MiTablet': 'MI PAD|HM NOTE 1W',
            ...
            'KocasoTablet': '(TB-1207)',
            'HisenseTablet': '(F5281|E2371)',
            'Hudl': 'Hudl HT7S3|Hudl 2',
            'TelstraTablet': 'T-Hub2',
            'GenericTablet': [
                'Android.*97D|Tablet(?!.*PC)|BNTV250A|MID-WCDMA|LogicPD Zoom2|A7EB|CatNova8|A1_07|CT704|CT1002',
                'M721|rk30sdk|EVOTAB|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|Tablet-PC-4|Tagi Tab',
                'M6pro|CT1020W|arc 10HD|TP750|QTAQZ3|WVT101|TM1088|KT107',
            ],
        }
    ...
    def search_os(self):
        if self.user_agent:
            for k, item in self.operatingSystems.items():
                if isinstance(item, list):
                    for v in item:
                        if bool(re.search(v, self.user_agent, re.I)):
                            self.os = k
                else:
                    if bool(re.search(item, self.user_agent, re.I)):
                        self.os = k

    def is_phone(self):
        if self.user_agent:
            for k, item in self.phoneDevices.items():
                if isinstance(item, list):
                    for v in item:
                        if bool(re.search(v, self.user_agent, re.I)):
                            return True
    ...
    def is_tablet(self):
        if self.user_agent:
            for k, item in self.tabletDevices.items():
                if isinstance(item, list):
                    for v in item:
                        if bool(re.search(v, self.user_agent, re.I)):
                            return True
